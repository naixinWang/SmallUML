 ...
 * </p>
 * <ul>
 *   <li>{@link EAA.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link EAA.impl.EntityImpl#getListeAttribute <em>Liste Attribute</em>}</li>
 *   <li>{@link EAA.impl.EntityImpl#getListeRole <em>Liste Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	protected EClass eStaticClass() {
		return EAAPackage.Literals.ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAAPackage.ENTITY__NAME, oldName, name));
	}
	...
	public EList<Attribute> getListeAttribute() {
		if (listeAttribute == null) {
			listeAttribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, EAAPackage.ENTITY__LISTE_ATTRIBUTE);
		}
	...
	public EList<Role> getListeRole() {
		if (listeRole == null) {
			listeRole = new EObjectContainmentEList<Role>(Role.class, this, EAAPackage.ENTITY__LISTE_ROLE);
		}
		return listeRole;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EAAPackage.ENTITY__LISTE_ATTRIBUTE:
				return ((InternalEList<?>)getListeAttribute()).basicRemove(otherEnd, msgs);
			case EAAPackage.ENTITY__LISTE_ROLE:
