 ...
 * </p>
 * <ul>
 *   <li>{@link EAA.impl.RoleImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleImpl extends MinimalEObjectImpl.Container implements Role {
	...
	protected EClass eStaticClass() {
		return EAAPackage.Literals.ROLE;
	}
	...
	public void setCardinality(String newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAAPackage.ROLE__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EAAPackage.ROLE__CARDINALITY:
