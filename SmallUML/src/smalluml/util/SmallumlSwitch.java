...
public class SmallumlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SmallumlPackage.SCHEMA_UML: {
				SchemaUML schemaUML = (SchemaUML)theEObject;
				T result = caseSchemaUML(schemaUML);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Schema UML</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Schema UML</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSchemaUML(SchemaUML object) {
		return null;
	}
